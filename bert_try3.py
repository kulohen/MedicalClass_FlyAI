...
# 读取训练集和测试集
train_df = pd.read_csv('data/input/MedicalClass/train.csv', sep='\t', names=['label', 'title', 'text']).astype(str)
test_df = pd.read_csv('data/input/MedicalClass/train.csv', sep='\t', names=['label', 'title', 'text']).astype(str)
